...
(function () {
  ...
  var KNOWLEDGE = [
    { title: 'Practical AI Audit', need: 'Practical AI Audit', url: 'https://bluechip-diagnostics.vercel.app/ai-audit', link: 'Read the full audit details', answers: [
      ['What does the audit cost?', 'C$999 per organization, including applicable tax, paid upfront. An inquiry does not book the audit or take payment. BlueChip confirms the next steps with you.'],
      ...
      ['How does the five-hour guarantee work?', 'If BlueChip cannot identify tool recommendations with evidence-backed potential to save at least five net hours per week across your organization in total, your audit fee is refunded in full. It is not five hours per employee. The hours can come from several opportunities, not just the one redesigned workflow. Actual results depend on implementation, adoption and workload.'],
      ['Do you implement the recommendations?', 'You implement the recommendations. The audit documents one redesigned workflow, recommended tools, responsibilities, human checkpoints and implementation steps. Software, configuration, automation builds, training and ongoing support are separate.'],
      ...
      ['What does the C$8,000 example mean?', 'Five hours a week multiplied by C$40 per hour and 40 working weeks equals C$8,000 a year in potential staff capacity. Those are illustrative assumptions, not guaranteed cash or payroll savings. Software and implementation costs are separate.'],
  ...
  function renderOffering() {
    ...
    if (data.need === 'Free AI Opportunity Check') {
      ...
      addMsg('The Practical AI Audit is C$999 per organization, including applicable tax, paid upfront. It includes a 60-minute discovery session, an organization-wide opportunity scan, one priority workflow redesigned, a written report and a 30-minute findings call.', 'bot');
      addMsg('Your report arrives within five business days after discovery and receipt of the required information. If we cannot identify evidence-backed potential to save five net hours per week across your organization in total, we refund the audit fee in full. You implement the recommendations. Software, setup and training are separate.', 'bot');
    } else {
