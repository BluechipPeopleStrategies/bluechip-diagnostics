...
(function () {
  ...
  function build() {
    ...
    greet = el('div', { 'class': 'bcw-greet', role: 'button', tabindex: '0', 'aria-label': 'Chat with Chip' },
      "<b>Got a people situation that needs a second set of eyes?</b><small>Tell us what's going on, and we will point you to the clearest next step. No charge for the first look, and it's confidential.</small>");
