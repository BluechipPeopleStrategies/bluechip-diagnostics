...
(function () {
  ...
  var KNOWLEDGE = [
    { slug: 'ai-handoff-plan', title: 'The AI Handoff Plan', need: 'The AI Handoff Plan', url: 'https://bluechip-diagnostics.vercel.app/ai-handoff-plan', link: 'Read the full plan details', answers: [
      ...
      ['What is included?', "One 60-minute discovery session, an organization-wide opportunity scan, your key workflows talked through, with where AI fits and where it doesn't, a written plan and a 30-minute findings call. The plan is yours to keep."],
      ['How does the three-hour guarantee work?', "If The AI Handoff Plan can't find tools with evidence-backed potential to save at least 3 net hours a week across your organization, your full fee comes back automatically within 10 business days of your findings call, no forms, no hoops. That's three hours in total, not three per person, and they can come from several opportunities, not only one workflow. You get a copy of the hours tally that scores it, and if you think we've scored it wrong, tell us within 30 days and we'll review it together. That review can only add to what you're owed. For a sense of scale, three hours a week could be worth about C$5,760 a year in staff capacity, based on an illustrative C$40 an hour over 48 working weeks. That's potential capacity, not a cash saving. The guarantee covers finding the hours. Your team puts the plan in place, and the hours you actually get back depend on that."],
      ['Do you set the tools up for us?', 'Not as part of the plan. You get the plan, the recommended tools and what it takes to set them up, and your team puts it in place. We favour tools you already have or can start with right away. If you would like a hand, we can work alongside your team through a retainer (six-month minimum), and the plan fee is credited if you start within 60 days of your findings call.'],
      ...
      ['What does the C$5,760 example mean?', 'Three hours a week multiplied by C$40 per hour and 48 working weeks equals C$5,760 a year in potential staff capacity. Those are illustrative assumptions, not guaranteed cash or payroll savings. Software and implementation costs are not included in the plan fee.'],
