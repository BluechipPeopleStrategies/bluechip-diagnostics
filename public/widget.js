...
(function () {
  ...
  var KNOWLEDGE = [
    { title: 'Practical AI Audit', need: 'Practical AI Audit', url: 'https://bluechip-diagnostics.vercel.app/ai-audit', link: 'Read the full audit details', answers: [
      ...
      ['Do you implement the recommendations?', 'You implement the recommendations. The audit documents one redesigned workflow, recommended tools, responsibilities, human checkpoints and implementation steps. Your organization is responsible for implementation and its costs, including software subscriptions and licences, configuration, integrations, automation builds, training and ongoing support. The audit fee covers the audit only, and the report lists expected software costs and setup effort so you can budget before committing.'],
