...
(function () {
  ...
  var KNOWLEDGE = [
    { title: 'Practical AI Audit', need: 'Practical AI Audit', url: 'https://bluechip-diagnostics.vercel.app/ai-audit', link: 'Read the full audit details', answers: [
      ...
      ['What does the C$10,400 example mean?', 'Five hours a week multiplied by C$40 per hour and 52 weeks equals C$10,400 a year in potential staff capacity. Those are illustrative assumptions, not guaranteed cash or payroll savings. Software and implementation costs are not included in the audit fee.'],
