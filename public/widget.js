...
(function () {
  ...
  var KNOWLEDGE = [
    { title: 'Practical AI Audit', need: 'Practical AI Audit', url: 'https://bluechip-diagnostics.vercel.app/ai-audit', link: 'Read the full audit details', answers: [
      ['What does the audit cost?', 'C$999 per organization, including applicable tax, paid upfront. An inquiry does not book the audit or take payment. BlueChip confirms the next steps with you. If you cancel before discovery, before any audit work has begun, the fee is refunded in full.'],
