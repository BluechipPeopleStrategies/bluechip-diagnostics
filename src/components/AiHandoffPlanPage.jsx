...
export default function AiHandoffPlanPage() {
  ...
  return <main className="bc-page ai-funnel ai-plan">
    <SiteHeader showCta />
    ...
    <details><summary>Do you set the tools up for us?</summary><p>Not as part of the plan itself. The plan gives you the tools and the setup steps. If you go further with us, yes. In an <a href={SPRINT_URL}>Implementation Sprint</a> we set up the redesigned workflow with your team. On a <a href={RETAINERS_URL}>Practical AI Retainer</a> we handle the setup, then keep the tools tuned and updated as the software changes. Software licences and any installs your IT team needs to do stay with you.</p></details>
