...
export default function AiAuditPage() {
  ...
  return <main className="bc-page ai-funnel">
    ...
    <details><summary>Is implementation included?</summary><p>No. We document the redesigned workflow, and you implement it and the other recommendations. Your organisation is responsible for implementation and its costs, including software subscriptions and licences, configuration, integrations, automation builds, training and ongoing support. The audit fee covers the audit only. The report lists the expected software costs and setup effort for each recommendation, so you can budget before committing. If you want help with implementation, AI-only or combined AI and HR support can be quoted separately.</p></details>
