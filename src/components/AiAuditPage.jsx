...
export default function AiAuditPage() {
  ...
  return <main className="bc-page ai-funnel">
    ...
    <section className="ai-panel"><h2>C$999 per organisation</h2><p><strong>Including applicable tax. Paid upfront.</strong></p><p>If we cannot identify tool recommendations with evidence-backed potential to save your organisation at least five net hours per week in total, we refund your audit fee in full.</p><p>You implement the recommendations. The guarantee covers identifying opportunities; actual savings depend on implementation.</p></section>
    ...
    <section><h2>What could five hours be worth?</h2><p>At an employee cost of $40 per hour, five hours a week represents <strong>$8,000 a year in potential staff capacity</strong>, calculated over 40 working weeks.</p><p>This is an illustration, not a payroll claim or guaranteed cash saving. You implement the recommendations. Software and implementation costs are separate.</p></section>
    ...
    <div className="ai-inclusions">
      ...
      <section><h3>A prioritised tool roadmap</h3><p>What to use, why it fits and where a simpler process or an existing tool is enough.</p></section>
      ...
      <section><h3>Costs and practical boundaries</h3><p>Software costs, setup effort, information permissions and the work that needs human review.</p></section>
    ...
    <h2>How the audit works</h2><ol className="ai-steps"><li>Agree the work covered and review the terms.</li><li>Pay upfront, then complete discovery.</li><li>Receive your report and findings walkthrough.</li><li>Choose and implement your next steps.</li></ol>
    ...
    <details><summary>Is implementation included?</summary><p>No. We document the redesigned workflow; you implement it and the other recommendations. Configuring tools, building automations, training, software subscriptions and ongoing support are separate. AI-only or combined AI and HR support can be discussed if useful.</p></details>
    ...
    <section className="ai-panel" aria-label="Discuss your audit"><h2>Talk through your Practical AI Audit</h2><p>Start a conversation with BlueChip to confirm the fit, scope and next steps. An inquiry does not create a booking or take payment.</p><p><a href="https://www.bluechip-people-strategies.com/embedded-hr-retainers#chat">Discuss your Practical AI Audit</a></p><p>If the audit leads into an advisory engagement, the audit fee is credited against your first advisory invoice.</p></section>
